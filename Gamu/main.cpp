...
bool loadMedia()
{
	...
	//Load dot texture
	if( !gDotTexture.loadFromFile( "image/spaceship.png" ) )
	{
    ...
    //Load red texture
	if( !gRedTexture.loadFromFile( "image/red.bmp" ) )
	{
	...
	//Load green texture
	if( !gGreenTexture.loadFromFile( "image/green.bmp" ) )
	{
	...
	//Load blue texture
	if( !gBlueTexture.loadFromFile( "image/blue.bmp" ) )
	{
	...
	if( !gShimmerTexture.loadFromFile( "image/shimmer.bmp" ) )
	{
